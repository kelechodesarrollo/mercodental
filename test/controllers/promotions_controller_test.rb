...
class PromotionsControllerTest < ActionController::TestCase
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post :create, promotion: { description: @promotion.description, image: @promotion.image, name: @promotion.name, option: @promotion.option }
    end
  ...
  test "should update promotion" do
    patch :update, id: @promotion, promotion: { description: @promotion.description, image: @promotion.image, name: @promotion.name, option: @promotion.option }
    assert_redirected_to promotion_path(assigns(:promotion))
  end
